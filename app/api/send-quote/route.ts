...
<div style="max-width:680px;margin:0 auto;background:#fff;box-shadow:0 4px 24px rgba(0,0,0,.1);">
  ...
  <table width="100%" cellpadding="0" cellspacing="0"><tr><td style="padding:36px 44px 0;">
    <div style="border-top:1px solid #ede7d9;padding-top:28px;">
      <table width="100%" cellpadding="0" cellspacing="0"><tr>
        <td style="font-size:12px;color:#8a7a5a;">Client Signature: ______________________________</td>
        <td style="font-size:12px;color:#8a7a5a;text-align:right;">Date: ___________________</td>
      </tr></table>
    </div>
  </td></tr></table>
